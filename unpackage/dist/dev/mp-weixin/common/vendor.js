...
P.cubeRoot = P.cbrt = function() {
  var e2, m2, n2, r, rep, s2, sd, t2, t3, t3plusx, x = this, Ctor = x.constructor;
...
P.squareRoot = P.sqrt = function() {
  var m2, n2, sd, r, rep, t2, x = this, d = x.d, e2 = x.e, s2 = x.s, Ctor = x.constructor;
  if (s2 !== 1 || !d || !d[0]) {
